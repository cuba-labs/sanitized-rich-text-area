...
public class StaTestContainer extends TestContainer {

    public StaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/example/demo/app.properties",
    ...
    public static class Common extends StaTestContainer {

        public static final StaTestContainer.Common INSTANCE = new StaTestContainer.Common();
